...
2. **Signing / SBOM / provenance** — what lands on the Release page.
...
## 2. Signing, SBOM, and SLSA provenance
...
- `<file>.intoto.jsonl` — SLSA v1 build-provenance attestation.
