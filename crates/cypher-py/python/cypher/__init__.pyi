...
Rust-side `#[pyclass]` / `#[pymethods]` surface in `crates/cypher-py/
...
class Diagnostic:
    ...
    def code(self) -> str:
        ...
        The registry lives in ``cypher-diag/src/codes.rs`` and is
...
class CypherDatabase:
    ...
    def schema_set(self, toml: str) -> None:
        ...
        ``cypher_schema::file::load_from_toml_str`` on the Rust side.
