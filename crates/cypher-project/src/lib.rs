//! `cypher-project` — `cypher-project.toml` manifest format and loader (spec 0003).
//!
...
//!
//! ```
//! # use cypher_project::{load_from_toml_str, DialectDefault};
//! let toml = r#"
//! [project]
//! name = "demo"
//!
...
#![forbid(unsafe_code)]
#![doc(html_root_url = "https://docs.rs/cypher-project/0.0.1")]
