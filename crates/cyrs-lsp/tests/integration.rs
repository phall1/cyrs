//! In-process integration test for cyrs-lsp. Spec 0001 §14, §17.11; bead cy-d48.
//!
//! Previously this file spawned the `cyrs-lsp` binary over stdio,
...
impl TestHarness {
    fn new() -> Self {
        ...
        let server_thread = thread::Builder::new()
            .name("cyrs-lsp-test-server".into())
