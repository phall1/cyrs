...
//! output produced by [`cypher_diag::render_text_string`].  The snapshots
...
use cypher_sema::{SemaOptions, analyse};
...
// ---------------------------------------------------------------------------
// E2010 — string request on non-string
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// E2011 — boolean request on non-boolean
// ---------------------------------------------------------------------------
