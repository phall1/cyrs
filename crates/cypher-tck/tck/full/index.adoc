...
* Boolean1 - And logical requests
* Boolean2 - OR logical requests
* Boolean3 - XOR logical requests
* Boolean4 - NOT logical requests
* Boolean5 - Interop of logical requests
...
* Temporal8 - Compute Arithmetic Requests on Temporal Values
