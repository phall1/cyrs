...
Therefore the request of moving a property from one entity to another will be noted as one removal and one addition in the side effects.
Likewise, the request of changing the value of a property is noted as one removal and one addition in the side effects.
...
- TypeError                      "The statement is attempting to perform requests on values with types that are not supported by the request."
- ArgumentError                  "The statement is attempting to perform requests using invalid arguments."
- ArithmeticError                "Invalid use of an arithmetic request, such as dividing by zero."
