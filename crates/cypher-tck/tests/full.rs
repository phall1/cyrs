...
//! through `cypher_db::Database`.  The result is a per-area parser-
...
fn render_baseline(
    ...
    out.push_str(
        "*Auto-generated by `cargo test -p cypher-tck --features full-tck` \
