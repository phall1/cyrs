...
wasm-bindgen --target web \
    --out-dir ./pkg \
    target/wasm32-unknown-unknown/release/cypher_wasm.wasm

# (optional) optimise — wasm-opt ships with binaryen
wasm-opt -Os -o ./pkg/cypher_wasm_bg.wasm ./pkg/cypher_wasm_bg.wasm

# brotli-compress for the size gate (spec 0004 §4.2, ≤ 2 MB)
brotli -q 11 ./pkg/cypher_wasm_bg.wasm -o ./pkg/cypher_wasm_bg.wasm.br
```
