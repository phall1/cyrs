//! Compiletest-style golden corpus for `cyrs-sema` (spec 0001 §17.6).
//!
//! Delegates to `cyrs_testkit::compiletest::run_ui_corpus` which discovers
...
//! # Blessing
//!
//! Set `BLESS=1` (or run `cargo xtask bless -p cyrs-sema`) to regenerate
