//! Neutral language-services engines shared by `cyrs-lsp` and
//! `cyrs-agent`. Spec 0001 §14 (LSP) / §15 (agent).
//!
...
//! (the original v1 cut, because `cyrs-lsp` pulls in
...
//!
//! ```text
//! cyrs-lang-services → cyrs-db, cyrs-hir, cyrs-schema,
//!                        cyrs-sema, cyrs-syntax, cyrs-ast,
//!                        cyrs-fmt
