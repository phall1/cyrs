...
//!
//! Pulls every [`cyrs_diag::Diagnostic::fixes`] whose `id` matches
...
//!
//! Non-applicable fixes tagged [`cyrs_diag::Applicability::
...
use cyrs_diag::{Applicability, Diagnostic};
...
/// release.  Construction is internal to `cyrs-lang-services`.
#[derive(Debug, Clone)]
#[non_exhaustive]
...
/// Run `db.all_diagnostics`, collect every [`cyrs_diag::FixIt`] whose
