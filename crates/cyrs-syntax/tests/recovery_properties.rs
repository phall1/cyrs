...
//! Exercised: E0064 — index-close, covered by `crates/cyrs-syntax/src/grammar/expression.rs` unit tests.
...
use cyrs_syntax::{SyntaxKind, parse};
...
// ---------------------------------------------------------------------------
//
// Hand-picked from `crates/cyrs-tck/tck/v1.toml` to cover MATCH, RETURN,
