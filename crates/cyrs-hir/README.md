...
[![crates.io](https://img.shields.io/crates/v/cyrs-hir.svg)](https://crates.io/crates/cyrs-hir)
[![docs.rs](https://img.shields.io/docsrs/cyrs-hir)](https://docs.rs/cyrs-hir)
...
High-level IR for Cypher / GQL: scope graph, name resolution, and
desugaring. Lowered from the typed AST. See spec 0001 §6.
